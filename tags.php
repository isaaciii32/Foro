...
<main role="main" class="container">
    <div class="my-3 p-3 rounded shadow-sm contBG1">
        <h6 class="border-bottom pb-2 mb-0">Categorias disponibles</h6>
        <div class="media pt-3">
            <form action="tags.php" method="post"><input type="hidden" name="categoria" value="1"><input type="submit" class="btn boton btn-sm " value="Electronica"></form>
            <form action="tags.php" method="post"><input type="hidden" name="categoria" value="2"><input type="submit" class="btn boton btn-sm " value="Robotica"></form>
            <form action="tags.php" method="post"><input type="hidden" name="categoria" value="3"><input type="submit" class="btn boton btn-sm " value="Informatica"></form>
            <form action="tags.php" method="post"><input type="hidden" name="categoria" value="4"><input type="submit" class="btn boton btn-sm " value="Redes"></form>
        </div>
    </div>
    <div class="my-3 p-3 rounded shadow-sm contBG1">
        <h6 class="border-bottom pb-2 mb-0">Temas con categoria</h6>
            <?php 
                if ($c >= 1) {
                    get_one_catg($c);
                }else
