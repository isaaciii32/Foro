...
<main role="main" class="container">
    <div class="my-3 p-3 rounded shadow-sm contBG1">
        <h6 class="border-bottom pb-2 mb-0">Temas recientes</h6>
        ...
        <small class="d-block text-right mt-3">
            <a class="linksCont" href="all.php">Ver todos los temas</a>
        </small>
    </div>
    <div class="my-3 p-3 rounded shadow-sm contBG1">
        <h6 class="border-bottom pb-2 mb-0">Tema destacado</h6>
